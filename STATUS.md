...
| Test | `pnpm -r test` | PASS — **2408 tests**, 0 failures |

Per-package tests: shared 341, core 266, accounts 111, git-sync 97, search 72, mcp 143, server 389,
web 989. The end-to-end suite (`pnpm e2e`) is 157 Playwright tests, all passing.
