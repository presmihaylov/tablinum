...
| Test | `pnpm -r test` | PASS — **2386 tests**, 0 failures |

Per-package tests: shared 341, core 266, accounts 111, git-sync 97, search 59, mcp 143, server 384,
web 985. The end-to-end suite (`pnpm e2e`) is 157 Playwright tests, all passing.
...
- 25 web tests (`apps/web/test/accounts.test.tsx`) cover the gate in front of the shell, the
