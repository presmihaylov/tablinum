...
| Test | `pnpm -r test` | PASS — **2429 tests**, 0 failures |

Per-package tests: shared 357, core 266, accounts 133, git-sync 97, search 59, mcp 143, server 406,
web 982. The end-to-end suite (`pnpm e2e`) is 157 Playwright tests.
